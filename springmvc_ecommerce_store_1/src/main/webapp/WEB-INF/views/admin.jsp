...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | HOME</title>
...
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="${pageContext.request.contextPath }/resources/admin/js/chartinator.js" ></script>
...
<!--skycons-icons-->
<script src="${pageContext.request.contextPath }/resources/admin/js/skycons.js"></script>
<!--//skycons-icons-->
</head>
<body>
		...
		<div class="col-md-6 chart-layer1-right"> 
			...
			<div class="malorm-bottom">
				...
				<ul class="malorum-icons">
					...
					<li><a href="http://google.com"><i class="fa fa-google-plus"> </i>
...
<div class="chart-layer-2">
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="${pageContext.request.contextPath }/resources/admin/js/bars.js"></script>
		...
		<div class="climate-grid1">
			<div class="climate-gd1-top">
				<div class="col-md-6 climate-gd1top-left">
					<h4>${dayOfTheWeek }, ${month } ${day }</h4>
					<h3>${time }<span class="timein-pms"></span></h3>				
					<p>Humidity:</p>					
					<p>Sunset:</p>
					<p>Sunrise:</p>
				</div>
