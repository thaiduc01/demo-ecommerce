...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | USER LIST</title>
					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form action="${pageContext.request.contextPath }/doSearchUser" method="get">
										<input name="keyword" type="text" placeholder="Search...(name)">	
...
<div class="inner-block" style="height: 846px;">
    <div class="product-block">
    	<div class="pro-head">
    		<h2 style="font-weight: bold; margin: 1px 1px;">Khách Hàng
    		...
    		<table class="table table-borderless main">
        		...
        		<tbody>
            		...
            		<tr class="rounded bg-white">
                		<td style="margin-left: 20%;" class="order-color">${item.userId }</td>
                		<td>${item.userName }</td>
                		<td class="d-flex align-items-center">${item.email }</td>
                		<td>${item.firstName } ${item.lastName }</td>
                		<td>${item.address } ${item.state } ${item.country }</td>
                		<td>${item.birthDay }/${item.birthMonth }/${item.birthYear }</td>
                		<td>${item.phone }</td>
                		<td class="view">
							<a title="Delete" style="font-size: 20px;" href="${pageContext.request.contextPath }/deleteUser?id=${item.userId }"><i class="fas fa-trash"></i></a>
                		</td>
            		</tr>
