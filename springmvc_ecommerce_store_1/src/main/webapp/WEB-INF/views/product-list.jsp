...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | PRODUCT LIST</title>
					...
					<div class="header-left">
							...
							<!--search-box-->
								<div style="width: 340px;" class="search-box">
									<form action="${pageContext.request.contextPath }/doSearch" method="get">
										<input style="width: 300px;" name="keyword" type="text" placeholder="Search...(name, price, category, description)">	
...
<div class="inner-block" style="height: 1050px;">
    <div class="product-block">
    	<div class="pro-head">
    		<h2 style="font-weight: bold; margin: 1px 1px;">Sản Phẩm
    			<div style="font-size: 17px;" class="shop-menu pull-right">
    				<div class="add-form">
					<ul class="nav navbar-nav">
						<li><a style="color: #68AE00;" href="${pageContext.request.contextPath }/addCategory"><i class="fa fa-user"></i>
												Thêm Danh Mục</a></li>
						<li><a style="color: #68AE00;" href="${pageContext.request.contextPath }/addProduct"><i class="fa fa-user"></i> 
												Thêm Sản Phẩm</a></li>
						<li><a style="color: #68AE00;" href="${pageContext.request.contextPath }/addSupplier"><i class="fa fa-user"></i> 
    		...
    		<table class="table table-borderless main">
        		...
        		<tbody>
            		...
            		<tr class="rounded bg-white">
                		<td style="margin-left: 20%; width: 50px;" class="order-color">${item.productID }</td>
                		<td style="text-align: center;"><img style="width: 50px; height: 60px;" src="${pageContext.request.contextPath }/${item.image[0].path}" alt="IMG-PRODUCT"></td>
                		<td class="d-flex align-items-center">${item.productName }</td>
                		<td>
                			<div class="dropdown"> <button style="text-transform: uppercase; font-size: 13px;" class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> ${item.productPrice } VND</button>
                    		</div>
                		</td>
                		<td>
                			<div class="dropdown"> <a title="Male=1/Female=2" style="text-transform: uppercase; font-size: 13px;" class="btn btn-primary btn-sm dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> ${item.sex } </a>
                    		</div>
                		</td>
                		<td>${item.category.categoryName }</td>
                		<td>${item.productDescription }</td>
                		<td class="view">
                			<a title="Edit" style="font-size: 20px;" href="${pageContext.request.contextPath }/updateProduct?id=${item.productID }"><i class="fas fa-edit"></i></a>
							<a title="Delete" style="font-size: 20px;" href="${pageContext.request.contextPath }/deleteProduct?id=${item.productID }"><i class="fas fa-trash"></i></a>
                		</td>
            		</tr>
            		</c:forEach>
            	</tbody>
...
<!--slider menu-->
    <div style="height: 1100px;" class="sidebar-menu">
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Trang</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		            ...
		            <li id="menu-academico-avaliacoes" ><a href="${pageContext.request.contextPath }/home">Trang Chủ</a></li>		           
		          </ul>
		        </li>
