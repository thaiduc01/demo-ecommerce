...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | ADD CATEGORY</title>
...
<div class="inner-block" style="height: 746px;">
    <div class="product-block">
    	<div class="pro-head">
    		<h2 style="font-weight: bold;">Thêm Danh Mục
    	...
    	<div class="form-css">
    		<form:form action="doAddCategory" method="post"	modelAttribute="category">
    			<div>
    			<p>
    				Tên Danh Mục: <form:input style="float: right; width: 60%;" path="categoryName" /></p>
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="${pageContext.request.contextPath }/admin"><i class="fa fa-tachometer"></i><span>Bảng chi tiết</span></a></li>
