...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | ADD SUPPLIER</title>
...
<div class="inner-block" style="height: 746px;">
    <div class="product-block">
    	<div class="pro-head">
    		<h2 style="font-weight: bold;">Thêm Nhà Cung Cấp
    			<div style="font-size: 17px;" class="shop-menu pull-right">
					<ul class="nav navbar-nav">
						<li>
							<div class="go_back">
    							<a href="${pageContext.request.contextPath }/product-list"><i class="fas fa-hand-point-left"></i> Quay lại</a>
    						</div>
						</li>
					</ul>
				</div>
    	...
    	<div class="form-css">
    		<form:form action="doAddSupplier" method="post" modelAttribute="supplier">
    			<div>
    				Tên Nhà Cung Cấp: <form:input style="float: right; width: 60%;" path="supplierName" />
							<form:errors path="supplierName" cssClass="error"></form:errors>
							<br>
    			</div>
    			<div>
    				SĐT: <form:input style="float: right; width: 60%;" path="supplierPhone" />
							<form:errors path="supplierPhone" cssClass="error"></form:errors>
							<br>
    			</div>
    			<div>
    				Địa Chỉ: <form:input style="float: right; width: 60%;" path="supplierAddress" />
							<form:errors path="supplierAddress" cssClass="error"></form:errors>
							<br>
    			</div>
    			<div>
    				Email: <form:input style="float: right; width: 60%;" path="supplierEmail" />
							<form:errors path="supplierEmail" cssClass="error"></form:errors>
							<br>
    			</div>
    			<div >
    				<input style="float: right;" class="nut-bam" type="submit" value="submit" />
    			</div>		
			</form:form>
    	</div>
        <div class="clearfix"> </div>
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="admin"><i class="fa fa-tachometer"></i><span>Bảng chi tiết</span></a></li>
		        <li><a href="#"><i class="fa fa-shopping-cart"></i><span>E-Commerce</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	<ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="product-list">Danh Sách Sản Phẩm</a></li>
			            <li id="menu-academico-boletim" ><a href="order-list">Danh Sách Đặt Hàng</a></li>
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Trang</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		          	 <li id="menu-academico-boletim" ><a href="shop">Shop</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="home">Trang Chủ</a></li>		           
		          </ul>
		        </li>
