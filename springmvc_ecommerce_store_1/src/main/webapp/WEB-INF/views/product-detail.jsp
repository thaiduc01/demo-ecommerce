...
<html lang="en">
<head>
<title>COZA STORE | PRODUCT DETAIL</title>
	<meta charset="UTF-8">
...
<body class="animsition">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<span class="header-cart-item-info">
								${item.order_quantity } x $${item.products.productPrice }
							</span>
						</div>
					</li>
				</c:forEach>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="${pageContext.request.contextPath }/shop" class="stext-109 cl8 hov-cl1 trans-04">
				Shop
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${pageContext.request.contextPath }/${product.image[0].path}">
									<div class="wrap-pic-w pos-relative">
										<img src="${pageContext.request.contextPath }/${product.image[0].path}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${pageContext.request.contextPath }/${product.image[0].path}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								<!--  <div class="item-slick3" data-thumb="${pageContext.request.contextPath }/${product.image[1].path}">
									<div class="wrap-pic-w pos-relative">
										<img src="${pageContext.request.contextPath }/${product.image[1].path}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${pageContext.request.contextPath }/${product.image[1].path}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								<div class="item-slick3" data-thumb="${pageContext.request.contextPath }/${product.image[2].path}">
									<div class="wrap-pic-w pos-relative">
										<img src="${pageContext.request.contextPath }/${product.image[2].path}" alt="IMG-PRODUCT">
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${pageContext.request.contextPath }/${product.image[2].path}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>-->
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input readonly="readonly" class="mtext-104 cl3 txt-center num-product" type="number" name="num-product" value="1">
									...
									<input type="hidden" name="orderdetail_id" value="${product.productID }">
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<!-- <div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="${pageContext.request.contextPath }/resources/client/images/avatar-01.jpg" alt="AVATAR">
											</div>
											<div class="size-207">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${pageContext.request.contextPath }/${item.image[0].path}" alt="IMG-PRODUCT">
							</div>
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="${pageContext.request.contextPath }/product-detail?id=${item.productID }" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										${item.productName }
									</a>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="${pageContext.request.contextPath }/resources/client/images/icons/icon-close.png" alt="CLOSE">
				</button>
				<div class="row">
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							...
							<div class="p-t-33">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<input value="Add to cart" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
									</div>
								</div>	
							</div>
							<div class="flex-w flex-m p-l-100 p-t-40 respon7">
