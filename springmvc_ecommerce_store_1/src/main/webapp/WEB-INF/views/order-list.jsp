...
<html>
<head>
<title>COZA STORE'S MANAGEMENT PAGE | ORDER LIST</title>
					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form action="${pageContext.request.contextPath }/doOrderSearch" method="get">
										<input name="keyword" type="text" placeholder="Search...(name, phone, address, email)">	
...
<div class="inner-block" style="height: 846px;">
    <div class="product-block">
    	<div class="pro-head">
    		<h2 style="font-weight: bold; margin: 1px 1px;">Thanh toán
    		...
    		<table class="table table-borderless main">
        		...
        		<tbody>
            		...
            		<tr class="rounded bg-white">
                		<td style="margin-left: 20%;" class="order-color">${item.order_id }</td>
                		<td>${item.order_date }</td>
                		<td class="d-flex align-items-center">${item.customers.customerName }</td>
                		<td>${item.customers.customerPhone }</td>
                		<td>${item.customers.customerAddress }</td>
                		<td>${item.customers.customerEmail }</td>
                		<td>
                    		<div class="dropdown"> <button style="text-transform: uppercase;" class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> ${item.order_status } </button>
                    		</div>
                		</td>
                		<td>
                			<div class="dropdown"> <button style="text-transform: uppercase;" class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"> ${item.payment_method } </button>
                    		</div>
                		</td>
                		<td>${item.credit_cards.cardholder_name }</td>
                		<td>${item.credit_cards.card_number }</td>
                		<td class="view">
                			<a title="View Details" href="${pageContext.request.contextPath }/order-detail?id=${item.order_id }"><i class="fas fa-eye"></i></a>
                		</td>
            		</tr>
            		</c:forEach>
            	</tbody>
